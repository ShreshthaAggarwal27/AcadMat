document.addEventListener('DOMContentLoaded', function() {
    ...
    const conditionFilterCheckboxes = document.querySelectorAll('input[name="conditionFilter"]');
    ...
    conditionFilterCheckboxes.forEach(function (checkbox) {
        checkbox.addEventListener('change', function () {
            const condition = checkbox.value.toLowerCase();
            bookCards.forEach(function (card) {
